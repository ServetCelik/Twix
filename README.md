...
```
cd existing_repo
git remote add origin https://git.fhict.nl/I489394/javatweetapi.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.fhict.nl/I489394/javatweetapi/-/settings/integrations)
